...
extern "C"
{
	...
	SHAPETYPE		INK_RecognizeShape( CGPoint * pStroke, int nStrokeCnt, SHAPETYPE inType );
	BOOL			INK_AddStroke( INK_DATA_PTR pData, CGPoint * pStroke, int nStrokeCnt, int iWidth, COLORREF color );
	...
	int 			INK_AddPixelToStroke( INK_DATA_PTR pData, int nStroke, float x, float y );
	...
	int				INK_Serialize( INK_DATA_PTR pData, BOOL bWrite, FILE * pFile, void ** ppData, int * pcbSize, BOOL skipImages );
