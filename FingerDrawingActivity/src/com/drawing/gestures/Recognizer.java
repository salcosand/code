...
public class Recognizer {
	...
	public Recognizer() {
		...
		// triangle
		List<Point> point0 = new ArrayList<Point>(Arrays.asList(new Point(137,
				139), new Point(135, 141), new Point(133, 144), new Point(132,
				146), new Point(130, 149), new Point(128, 151), new Point(126,
				155), new Point(123, 160), new Point(120, 166), new Point(116,
				171), new Point(112, 177), new Point(107, 183), new Point(102,
				188), new Point(100, 191), new Point(95, 195), new Point(90,
				199), new Point(86, 203), new Point(82, 206),
				new Point(80, 209), new Point(75, 213), new Point(73, 213),
				new Point(70, 216), new Point(67, 219), new Point(64, 221),
				new Point(61, 223), new Point(60, 225), new Point(62, 226),
				new Point(65, 225), new Point(67, 226), new Point(74, 226),
				new Point(77, 227), new Point(85, 229), new Point(91, 230),
				new Point(99, 231), new Point(108, 232), new Point(116, 233),
				new Point(125, 233), new Point(134, 234), new Point(145, 233),
				new Point(153, 232), new Point(160, 233), new Point(170, 234),
				new Point(177, 235), new Point(179, 236), new Point(186, 237),
				new Point(193, 238), new Point(198, 239), new Point(200, 237),
				new Point(202, 239), new Point(204, 238), new Point(206, 234),
				new Point(205, 230), new Point(202, 222), new Point(197, 216),
				new Point(192, 207), new Point(186, 198), new Point(179, 189),
				new Point(174, 183), new Point(170, 178), new Point(164, 171),
				new Point(161, 168), new Point(154, 160), new Point(148, 155),
				new Point(143, 150), new Point(138, 148), new Point(136, 148)));
		AddTemplate("triangle", point0, GestureTypes.TOPIC);

		// x
		List<Point> point1 = new ArrayList<Point>(Arrays.asList(new Point(87,
				142), new Point(89, 145), new Point(91, 148),
				new Point(93, 151), new Point(96, 155), new Point(98, 157),
				new Point(100, 160), new Point(102, 162), new Point(106, 167),
				new Point(108, 169), new Point(110, 171), new Point(115, 177),
				new Point(119, 183), new Point(123, 189), new Point(127, 193),
				new Point(129, 196), new Point(133, 200), new Point(137, 206),
				new Point(140, 209), new Point(143, 212), new Point(146, 215),
				new Point(151, 220), new Point(153, 222), new Point(155, 223),
				new Point(157, 225), new Point(158, 223), new Point(157, 218),
				new Point(155, 211), new Point(154, 208), new Point(152, 200),
				new Point(150, 189), new Point(148, 179), new Point(147, 170),
				new Point(147, 158), new Point(147, 148), new Point(147, 141),
				new Point(147, 136), new Point(144, 135), new Point(142, 137),
				new Point(140, 139), new Point(135, 145), new Point(131, 152),
				new Point(124, 163), new Point(116, 177), new Point(108, 191),
				new Point(100, 206), new Point(94, 217), new Point(91, 222),
				new Point(89, 225), new Point(87, 226), new Point(87, 224)));
		// AddTemplate("x", point1, GestureTypes.PERSON);
		...
		List<Point> point2 = new ArrayList<Point>(Arrays.asList(new Point(78,
				...
				new Point(76, 133)));
		AddTemplate("rectangle", point2, GestureTypes.TOPIC);
		...
		AddTemplate("circle", point3, GestureTypes.TOPIC);

		// check
		List<Point> point4 = new ArrayList<Point>(Arrays.asList(new Point(91,
				185), new Point(93, 185), new Point(95, 185),
				new Point(97, 185), new Point(100, 188), new Point(102, 189),
				new Point(104, 190), new Point(106, 193), new Point(108, 195),
				new Point(110, 198), new Point(112, 201), new Point(114, 204),
				new Point(115, 207), new Point(117, 210), new Point(118, 212),
				new Point(120, 214), new Point(121, 217), new Point(122, 219),
				new Point(123, 222), new Point(124, 224), new Point(126, 226),
				new Point(127, 229), new Point(129, 231), new Point(130, 233),
				new Point(129, 231), new Point(129, 228), new Point(129, 226),
				new Point(129, 224), new Point(129, 221), new Point(129, 218),
				new Point(129, 212), new Point(129, 208), new Point(130, 198),
				new Point(132, 189), new Point(134, 182), new Point(137, 173),
				new Point(143, 164), new Point(147, 157), new Point(151, 151),
				new Point(155, 144), new Point(161, 137), new Point(165, 131),
				new Point(171, 122), new Point(174, 118), new Point(176, 114),
				new Point(177, 112), new Point(177, 114), new Point(175, 116),
				new Point(173, 118)));
//		AddTemplate("check", point4, GestureTypes.CHECK);

		// caret
		// Point[] point5 = { new Point(79, 245), new Point(79, 242),
		// new Point(79, 239), new Point(80, 237), new Point(80, 234),
		// new Point(81, 232), new Point(82, 230), new Point(84, 224),
		// new Point(86, 220), new Point(86, 218), new Point(87, 216),
		// new Point(88, 213), new Point(90, 207), new Point(91, 202),
		// new Point(92, 200), new Point(93, 194), new Point(94, 192),
		// new Point(96, 189), new Point(97, 186), new Point(100, 179),
		// new Point(102, 173), new Point(105, 165), new Point(107, 160),
		// new Point(109, 158), new Point(112, 151), new Point(115, 144),
		// new Point(117, 139), new Point(119, 136), new Point(119, 134),
		// new Point(120, 132), new Point(121, 129), new Point(122, 127),
		// new Point(124, 125), new Point(126, 124), new Point(129, 125),
		// new Point(131, 127), new Point(132, 130), new Point(136, 139),
		// new Point(141, 154), new Point(145, 166), new Point(151, 182),
		// new Point(156, 193), new Point(157, 196), new Point(161, 209),
		// new Point(162, 211), new Point(167, 223), new Point(169, 229),
		// new Point(170, 231), new Point(173, 237), new Point(176, 242),
		// new Point(177, 244), new Point(179, 250), new Point(181, 255),
		// new Point(182, 257) };
		// AddTemplate("caret", point5);

		// question
		List<Point> point6 = new ArrayList<Point>(Arrays.asList(new Point(104,
				145), new Point(103, 142), new Point(103, 140), new Point(103,
				138), new Point(103, 135), new Point(104, 133), new Point(105,
				131), new Point(106, 128), new Point(107, 125), new Point(108,
				123), new Point(111, 121), new Point(113, 118), new Point(115,
				116), new Point(117, 116), new Point(119, 116), new Point(121,
				115), new Point(124, 116), new Point(126, 115), new Point(128,
				114), new Point(130, 115), new Point(133, 116), new Point(135,
				117), new Point(140, 120), new Point(142, 121), new Point(144,
				123), new Point(146, 125), new Point(149, 127), new Point(150,
				129), new Point(152, 130), new Point(154, 132), new Point(156,
				134), new Point(158, 137), new Point(159, 139), new Point(160,
				141), new Point(160, 143), new Point(160, 146), new Point(160,
				149), new Point(159, 153), new Point(158, 155), new Point(157,
				157), new Point(155, 159), new Point(153, 161), new Point(151,
				163), new Point(146, 167), new Point(142, 170), new Point(138,
				172), new Point(134, 173), new Point(132, 175), new Point(127,
				175), new Point(124, 175), new Point(122, 176), new Point(120,
				178), new Point(119, 180), new Point(119, 183), new Point(119,
				185), new Point(120, 190), new Point(121, 194), new Point(122,
				200), new Point(123, 205), new Point(123, 211), new Point(124,
				215), new Point(124, 223), new Point(124, 225)));
		// AddTemplate("question", point6, GestureTypes.PERSON);
		...
		// left square bracket
		List<Point> point8 = new ArrayList<Point>(Arrays.asList(new Point(140,
				124), new Point(138, 123), new Point(135, 122), new Point(133,
				123), new Point(130, 123), new Point(128, 124), new Point(125,
				125), new Point(122, 124), new Point(120, 124), new Point(118,
				124), new Point(116, 125), new Point(113, 125), new Point(111,
				125), new Point(108, 124), new Point(106, 125), new Point(104,
				125), new Point(102, 124), new Point(100, 123), new Point(98,
				123), new Point(95, 124), new Point(93, 123),
				...
				new Point(159, 237)));
		// AddTemplate("left square bracket", point8, GestureTypes.PERSON);

		// right square bracket.
		List<Point> point9 = new ArrayList<Point>(Arrays.asList(new Point(112,
				138), new Point(112, 136), new Point(115, 136), new Point(118,
				137), new Point(120, 136), new Point(123, 136), new Point(125,
				136), new Point(128, 136), new Point(131, 136), new Point(134,
				135), new Point(137, 135), new Point(140, 134), new Point(143,
				133), new Point(145, 132), new Point(147, 132), new Point(149,
				132), new Point(152, 132), new Point(153, 134), new Point(154,
				137), new Point(155, 141), new Point(156, 144), new Point(157,
				152), new Point(158, 161), new Point(160, 170), new Point(162,
				182), new Point(164, 192), new Point(166, 200), new Point(167,
				209), new Point(168, 214), new Point(168, 216), new Point(169,
				221), new Point(169, 223), new Point(169, 228), new Point(169,
				231), new Point(166, 233), new Point(164, 234), new Point(161,
				235), new Point(155, 236), new Point(147, 235), new Point(140,
				233), new Point(131, 233), new Point(124, 233), new Point(117,
				235), new Point(114, 238), new Point(112, 238)));
		// AddTemplate("right square bracket", point9, GestureTypes.PERSON);
		...
		// pig tail
		List<Point> point15 = new ArrayList<Point>(Arrays.asList(new Point(81,
				219), new Point(84, 218), new Point(86, 220),
		...
		AddTemplate("pigtail", point15, GestureTypes.MATCHCONTACT);

		// person

		List<Point> point16 = new ArrayList<Point>(Arrays.asList(

		new Point(-157, -3), new Point(-153, -16), new Point(-147, -27),
				new Point(-141, -38), new Point(-134, -48),
				new Point(-126, -55), new Point(-117, -62),
				new Point(-108, -63), new Point(-99, -63), new Point(-89, -59),
				new Point(-81, -52), new Point(-72, -47), new Point(-64, -40),
				new Point(-56, -33), new Point(-48, -26), new Point(-39, -19),
				new Point(-31, -13), new Point(-22, -8), new Point(-13, -4),
				new Point(-4, 0), new Point(4, 5), new Point(13, 6), new Point(
						23, 6), new Point(32, 9), new Point(41, 7), new Point(
						51, 5), new Point(59, 0), new Point(64, -13),
				new Point(64, -27), new Point(61, -40), new Point(56, -53),
				new Point(48, -60), new Point(40, -69), new Point(32, -67),
				new Point(22, -69), new Point(13, -67), new Point(4, -63),
				new Point(-4, -58), new Point(-11, -50), new Point(-16, -38),
				new Point(-17, -24), new Point(-12, -12), new Point(-6, -2),
				new Point(1, 5), new Point(10, 10), new Point(19, 13),
				new Point(28, 16), new Point(38, 19), new Point(47, 22),
				new Point(56, 27), new Point(65, 32), new Point(72, 41),
				new Point(79, 50), new Point(87, 59), new Point(93, 70),
				new Point(95, 84), new Point(96, 98), new Point(95, 112),
				new Point(93, 126), new Point(91, 140), new Point(87, 153),
				new Point(84, 167), new Point(80, 180), new Point(80, 180)

		));
		AddTemplate("person", point16, GestureTypes.PERSON);
